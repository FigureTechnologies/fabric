...
$(BUILD_DIR)/images/%/$(DUMMY):
	...
	docker tag $(DOCKER_NS)/fabric-$* us.gcr.io/figure-development/fabric-$*:$(DOCKER_TAG)
	@touch $@
...
%-docker-tag-latest:
	...
	docker tag $(DOCKER_NS)/fabric-$*:$(DOCKER_TAG) us.gcr.io/figure-development/fabric-$*:latest
...
%-docker-tag-stable:
	...
	docker tag $(DOCKER_NS)/fabric-$*:$(DOCKER_TAG) us.gcr.io/figure-development/fabric-$*:stable
